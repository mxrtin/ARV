...
namespace DX
{
    ...
    public:
        ...
        Windows::Graphics::Display::DisplayOrientations GetNativeOrientation() { return m_nativeOrientation; }
        Windows::Graphics::Display::DisplayOrientations GetCurrentOrientation() { return m_currentOrientation; }
